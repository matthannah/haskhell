...
instance Functor Parser where
  -- fmap :: (a -> b) -> f a -> f b
  -- rp :: String -> Maybe (a, String)
  -- we want to return something of the form Parser (runParser :: String -> Maybe (b, String))
  -- use lambda to emulate the structure (from shannon)
...
-- If I have multiple parsers and a string to run through all of them
